...
const leadership = [
  {
    ...
    bio: "A veteran business tycoon with decades of experience in the coal sector and industrial ventures. His vast knowledge and strategic vision have established Saikrupa Group as an industry leader.",
    image: "/professional-businessman.png",
  },
  {
    name: "Mr. Nikhil Dhanda",
    role: "Executive Director",
    bio: "MBA in Human Resource and Marketing. His dynamic leadership and industry relationships drive operational excellence and expansion into renewable energy sectors.",
